...
NrRepetitions             = 5000;                   % Number of Monte Carlo repetition (different channel realizations)             
...
ylabel('NMSE (dB)');
set(gca,'XTick',[0 10 20 30 40],'FontName','Times New Roman','FontSize',12,'GridLineStyle','--','GridLineWidth',1.2);
