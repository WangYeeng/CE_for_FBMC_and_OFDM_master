classdef FastFading < handle
    ...
    methods
        function obj = FastFading(...
                ...
                PowerDelayProfile,...                              % Power delay profile, either string or vector: 'Flat', 'AWGN', 'PedestrianA', 'PedestrianB', 'VehicularA', 'VehicularB', 'ExtendedPedestrianA', or 'TDL-A_xxns','TDL-B_xxns','TDL-C_xxns' (with xx the RMS delay spread in ns, e.g. 'TDL-A_30ns'), or [1 0 0.2] (Self-defined power delay profile which depends on the sampling rate)
        ...
        function CorrelationMatrix = GetCorrelationMatrix(obj)
            % returns the correlation matrix of the vectorized convolution matrix.
