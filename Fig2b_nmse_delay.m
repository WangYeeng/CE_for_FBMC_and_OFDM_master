...
%% Parameters
% Simulation
M_SNR_dB                  = 15;                      % Signal-to-Noise Ratio in dB
...
xlabel('RMS Delay (ns)');
ylim([-30 -10]);
set(gca,'Ytick',[-30 -25 -20 -15 -10],'Xtick',[50 150 250 350 450 550],'FontName','Times New Roman','FontSize',12,'GridLineStyle','-.','GridLineWidth',1.2,'LooseInset', [0,0,0,0]);
